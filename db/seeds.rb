...
course_phys2211 = safe_create Course.new(id: 6, name: 'PHYS 2211', description: 'Physics I', hours: 4, course_groups: [course_group_lab_sciences])
course_phys2212 = safe_create Course.new(id: 7, name: 'PHYS 2212', description: 'Physics II', hours: 4, course_groups: [course_group_lab_sciences])
course_chem1310 = safe_create Course.new(id: 8, name: 'CHEM 1310', description: 'General Chemistry', hours: 4, course_groups: [course_group_lab_sciences])
course_chem1211 = safe_create Course.new(id: 9, name: 'CHEM 1211', description: 'Chemistry I', hours: 4, course_groups: [course_group_lab_sciences])
course_chem1212 = safe_create Course.new(id: 10, name: 'CHEM 1212', description: 'Chemistry II', hours: 4, course_groups: [course_group_lab_sciences])
course_eas1600 = safe_create Course.new(id: 11, name: 'EAS 1600', description: 'Earth and Atmospheric Sciences I', hours: 4, course_groups: [course_group_lab_sciences])
course_eas1601 = safe_create Course.new(id: 12, name: 'EAS 1601', description: 'Earth and Atmospheric Sciences II', hours: 4, course_groups: [course_group_lab_sciences])
